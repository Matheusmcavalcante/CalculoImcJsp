...
<br>
	<div class="row">
 	<div class="col-md-4 col-md-offset-4">
		  ...
		  <div class="col-md-4">
		  <input type ="text" value="<%= imc %>" class="form-control" placeholder="Resultado"/>
		  ...
		  <div class="col-md-8">
            ...
            <br>
               ...
               <%  if (imc<18.5) { %>
                    <p>Você está muito abaixo do peso</p>

                    <% } else if (imc>=18.5 && imc<24.9) { %>
                    <p>Seu peso está normal</p>

                    <% } else if (imc>=25 && imc<29.9) { %>
                    <p>Você está acima do peso</p>

                    <% } else { %>
                    <p>Você é considerada uma pessoa obesa</p>
                    <% } %>
          </div>
		  </div>
